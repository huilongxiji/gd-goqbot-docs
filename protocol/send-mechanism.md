...
群主动推送：需群主打开【机器人在群聊内发言】。官方频控为 Bot 维度 60/qpm（未认证 30/qpm）、单关系 20/qpm、每个群每天最多 1000 条。对应 `send_group_active_msg`，或 `send_group_msg` 未命中任何被动凭证时。详见 [已知限制](/guide/limits)。
