...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'goqbot' }],
    ['meta', { property: 'og:title', content: 'goqbot | QQ 官方机器人 ↔ OneBot V11 适配器' }],
    ['meta', { property: 'og:description', content: '一个由 Go 单文件构成的协议端，提供了 QQ 官方机器人与 OneBot V11 / NoneBot2 之间的桥接。' }],
    ['meta', { property: 'og:url', content: 'https://huilongxiji.github.io/gd-goqbot-docs/' }],
    ['meta', { property: 'og:image', content: 'https://huilongxiji.github.io/gd-goqbot-docs/og.png' }],
    ['meta', { property: 'og:image:width', content: '1200' }],
    ['meta', { property: 'og:image:height', content: '630' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'goqbot | QQ 官方机器人 ↔ OneBot V11 适配器' }],
    ['meta', { name: 'twitter:description', content: '一个由 Go 单文件构成的协议端，提供了 QQ 官方机器人与 OneBot V11 / NoneBot2 之间的桥接。' }],
    ['meta', { name: 'twitter:image', content: 'https://huilongxiji.github.io/gd-goqbot-docs/og.png' }],
